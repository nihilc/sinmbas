...
if (isset($_POST['confirm'])) {
  ...
  try {
    ...
    if ($form_ok == true) AddUsuario($f_type, $f_icard, $f_name, $f_surname, $f_address, $f_phone, $f_email,);
  } catch (Exception $e) {
  ...
  <form class="form__add" method="post">
    ...
    <div class="form__secs">
      ...
      <div class="form__sec">
        ...
        <input class="form__input" type="number" name="icard" value="<?php if (isset($f_icard)) echo $f_icard ?>">
      </div>
      <div class="form__sec">
        <label class="form__label">Nombre*</label>
        <input class="form__input" type="text" name="name" value="<?php if (isset($f_name)) echo $f_name ?>">
      </div>
      <div class="form__sec">
        <label class="form__label">Apellido*</label>
        <input class="form__input" type="text" name="surname" value="<?php if (isset($f_surname)) echo $f_surname ?>">
      </div>
      <div class="form__sec">
        <label class="form__label">Direccion*</label>
        <input class="form__input" type="text" name="address" value="<?php if (isset($f_address)) echo $f_address ?>">
      </div>
      <div class="form__sec">
        <label class="form__label">Telefono*</label>
        <input class="form__input" type="number" name="phone" value="<?php if (isset($f_phone)) echo $f_phone ?>">
      </div>
      <div class="form__sec">
        <label class="form__label">Email*</label>
        <input class="form__input" type="email" name="email" value="<?php if (isset($f_email)) echo $f_email ?>">
      </div>
    </div>
